...
parser.add_argument('--sym', action='store_true',
                    help='enable symmetric front-end (default: False)')
...
parser.add_argument('--sym_causal', action='store_true',
                    help='use causal symmetric conv (default: False)')
parser.add_argument('--sym_no_residual', action='store_true',
                    help='disable residual add; use pure front output (default: False)')
...
tied = args.tied
base_tcn = TCN(args.emsize, n_words, num_chans,
               dropout=dropout, emb_dropout=emb_dropout,
               kernel_size=k_size, tied_weights=tied)
# Wrap with Hartley front-end (pass-through unless --sym is used)
model = HartleyTCN(
    base_tcn=base_tcn,
